    ...
    return (
        ...
        <div className="mainleft">
            ...
            <Table className="table-image striped bordered hover" size="sm">
                ...
                <tbody>
    {/* Mapping through every element in the array and displaying data in table */}
    {data.map((category) => (
        <tr key={category._id}>  {/* ✅ Added a unique key */}
            <td>{category.name}</td>

            {/* Passing category data to the update function */}
            <td>
            ...
            {/* Passing category ID to the delete function */}
            <td>
                <Button
